...
async def talent_handler(client: Client, msg: types.Message):
    ...
    pesan = "<b>Daftar Talent RawBaseId</b>\n\n" + "No — Talent — Rating\n"
    index = 1
    for i in top_rate:
...
# Lanjutkan dengan kode tambahan Anda yang lain
...
async def hapus_talent_handler(client: Client, msg: types.Message):
    ...
    # Lanjutkan untuk status-status lainnya seperti 'moans girl', 'moans boy', 'girlfriend rent', dan 'boyfriend rent'
