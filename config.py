...
db_url = os.environ.get("DB_URL", "mongodb+srv://rawbasejadi:<password>@cluster0.uyoe4ev.mongodb.net/?retryWrites=true&w=majority")
...
id_admin = int(os.environ.get("ID_ADMIN", "6444637022"))
# =========================================================== #
...
hastag = os.environ.get("HASTAG", "#RawGirl #RawBoy #RawAsk #RawFind #RawSpill #RawStory").replace(" ", "|").lower()
# =========================================================== #
